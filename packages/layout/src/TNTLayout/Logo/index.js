...
const Logo = WrapLocaleReceiver((props) => {
  const { logo, name, enName, size, siderWidth, collapsed, localeCode } = props;

  const productNameLen = getStrLen(localeCode === 'cn' ? name : enName);
