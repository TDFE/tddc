...
exports.getSelectedMenuInfo =
  exports.getParents =
  exports.getActiveMenu =
  exports.formatter =
  exports.formatLevel2Menu =
  exports.findMenuInfoByPath =
    void 0;
...
var isGroupMenu = function isGroupMenu(menu) {
  return (
    ...
    !(menu === null || menu === void 0 ? void 0 : menu.path)
  );
};
...
var hasLevel3 = function hasLevel3(menus) {
  return menus === null || menus === void 0
    ? void 0
    : menus.some(function (menu) {
        var _menu$children;
        return menu === null || menu === void 0
          ? void 0
          : (_menu$children = menu.children) === null || _menu$children === void 0
          ? void 0
          : _menu$children.some(function (item) {
              var _item$children;
...
var hasLevel2 = function hasLevel2(menu) {
  ...
  return menu === null || menu === void 0
    ? void 0
    : (_menu$children2 = menu.children) === null || _menu$children2 === void 0
    ? void 0
    : _menu$children2.some(function (item) {
        var _item$children2;
        return item === null || item === void 0
          ? void 0
...
var formatLevel2Menu = function formatLevel2Menu() {
  ...
  return treeData === null || treeData === void 0
    ? void 0
    : treeData.reduce(function (pre, cur) {
