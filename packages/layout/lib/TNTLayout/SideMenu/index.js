...
var SideMenu = function SideMenu(props) {
  ...
  var onSelectMenu = function onSelectMenu(params) {
    ...
    var defaultSelect = function defaultSelect(_ref) {
      ...
      var routerPrefix = (_window$location$path = window.location.pathname.match(/(^\/[^\/]+)/i)) === null || _window$location$path === void 0 ? void 0 : _window$location$path[1];
  ...
  var onMenuClick = function onMenuClick(key, menuItem) {
    ...
    var parentCode = ((_menuItem$parent = menuItem.parent) === null || _menuItem$parent === void 0 ? void 0 : _menuItem$parent.code) || ''; // 展开openKey
  ...
  var getSubMenuProps = function getSubMenuProps(_ref4) {
    ...
    return {
      key: code,
      title: !isHasLevel3 ? /*#__PURE__*/_react.default.createElement("span", {
        ...
        className: "menu-title"
      }, collapsed ? /*#__PURE__*/_react.default.createElement(_Icon.default, {
        type: groupIcon
      }) : null, collapsed ? '' : {
        cn: groupName,
        en: enName
      }[language]),
      expandIcon: collapsed ? null : /*#__PURE__*/_react.default.createElement(_Icon.default, {
  ...
  var renderMenu = function renderMenu(menu) {
    return hasChild(menu) ? /*#__PURE__*/_react.default.createElement(SubMenu, _extends({
      onTitleClick: function onTitleClick(_ref5) {
        var key = _ref5.key;
        onMenuClick(key, menu);
      }
    }, getSubMenuProps(menu)), menu.children.map(function (item) {
  ...
  }, isHasLevel3 && /*#__PURE__*/_react.default.createElement("div", {
