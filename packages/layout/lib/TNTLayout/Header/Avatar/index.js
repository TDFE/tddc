...
var UserInfoContent = function UserInfoContent(props) {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      language &&
        /*#__PURE__*/ _react.default.createElement(_Language.default, {
          size: size,
      ...
      supportLevelChange &&
        /*#__PURE__*/ _react.default.createElement(_MenuLevel.default, {
        ...
        'a',
        {
          ...
          onClick: function onClick() {
            if (onLogout) {
              ...
              (0, _deleteAllCookies.default)(window)();
              window.location.href = '/user/login?callbackUrl='.concat(
                window.encodeURI(location.href),
              );
            }
          },
        },
            ...
            onError: function onError(e) {
              ...
              e.target.src =
                ((_images$empty = _images.default.empty) === null || _images$empty === void 0
                  ? void 0
                  : _images$empty.default) || _images.default.empty;
            },
          })
        : /*#__PURE__*/ _react.default.createElement('img', {
            src:
              ((_images$empty2 = _images.default.empty) === null || _images$empty2 === void 0
                ? void 0
                : _images$empty2.default) || _images.default.empty,
          }),
    ),
  );
};
