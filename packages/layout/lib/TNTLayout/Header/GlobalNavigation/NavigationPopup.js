...
var SearchList = function SearchList(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("ul", null, items === null || items === void 0 ? void 0 : items.map(function (item) {
...
var _default = function _default(_ref2) {
  ...
  var onMenuClick = function onMenuClick(menu) {
    _eventEmitter.default.emit('menuSelectPopup', _objectSpread({
      key: menu.code
    }, menu));
  ...
  var debounceSearch = (0, _lodash.debounce)(function (evt) {
    ...
    var value = (_evt$target$value = evt.target.value) === null || _evt$target$value === void 0 ? void 0 : _evt$target$value.trim();
    var matchedMenus = [];
    ...
    if (value) {
      (0, _utils.traverseTree)(menus, function (node) {
        ...
        if (node.path && (node === null || node === void 0 ? void 0 : (_node$menuName = node.menuName) === null || _node$menuName === void 0 ? void 0 : _node$menuName.includes(value))) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    type: "close",
    onClick: close
  }), (searchedMenus === null || searchedMenus === void 0 ? void 0 : searchedMenus.length) > 0 && /*#__PURE__*/_react.default.createElement(SearchList, {
    items: searchedMenus,
    onSelectMenu: onMenuClick
  })), isHasLevel3 && /*#__PURE__*/_react.default.createElement("ul", {
    className: "main-menu"
  }, mainMenu === null || mainMenu === void 0 ? void 0 : mainMenu.map(function (menu) {
    return /*#__PURE__*/_react.default.createElement("li", {
  ...
  }, menuList === null || menuList === void 0 ? void 0 : menuList.map(function (groups) {
    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h5", null, groups === null || groups === void 0 ? void 0 : groups[language === 'cn' ? 'groupName' : 'enName']), /*#__PURE__*/_react.default.createElement("ul", {
      className: "menu-list"
    }, groups === null || groups === void 0 ? void 0 : groups.children.map(function (menu) {
      return /*#__PURE__*/_react.default.createElement("li", {
        key: menu.code,
