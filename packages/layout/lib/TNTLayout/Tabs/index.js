  ...
  var closeTabHandle = function closeTabHandle(tab, index, evt) {
      ...
      newSelectedKey =
        index === 0
          ? (_newTabItems$ = newTabItems[0]) === null || _newTabItems$ === void 0
            ? void 0
            : _newTabItems$.key
          : (_newTabItems = newTabItems[index - 1]) === null || _newTabItems === void 0
          ? void 0
          : _newTabItems.key;
    ...
    onTabClose === null || onTabClose === void 0
      ...
      : onTabClose(
          tab,
          newTabItems,
          newTabItems.find(function (_ref2) {
            var key = _ref2.key;
        ...
        return /*#__PURE__*/ _react.default.createElement(
          'li',
          {
            ...
            className: (0, _classnames.default)({
              ...
              activeTabPreSibling:
                ((_tabItems = tabItems[index + 1]) === null || _tabItems === void 0
                  ? void 0
                  : _tabItems.key) === selectedKey,
            }),
