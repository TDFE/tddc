...
var _default = function _default(props) {
  ...
  var renderItems = function renderItems() {
    ...
    flowNodesDict === null || flowNodesDict === void 0
      ? void 0
      : flowNodesDict.map(function (item) {
  ...
  var itemDom = function itemDom(item) {
    return /*#__PURE__*/ _react.default.createElement(
      ...
      null,
      (item === null || item === void 0 ? void 0 : item.prefixName) &&
        /*#__PURE__*/ _react.default.createElement(
          'span',
          {
            style: {
              backgroundColor:
                (item === null || item === void 0 ? void 0 : item.iconColor) || '#e6b55e',
            },
          },
          item === null || item === void 0 ? void 0 : item.prefixName,
        ),
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(
      ...
      {
        style: {
          left: (dragItem === null || dragItem === void 0 ? void 0 : dragItem.name)
            ? pageX - size[0] / 2
            : -9999,
          top: (dragItem === null || dragItem === void 0 ? void 0 : dragItem.name)
            ? pageY - size[1] / 2
            : -9999,
          display: (dragItem === null || dragItem === void 0 ? void 0 : dragItem.type)
            ? 'block'
            : 'none',
          zIndex: 10,
        },
