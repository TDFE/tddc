...
var _default = function _default(props) {
  ...
  var watchHistory = function watchHistory(props) {
    ...
    editor.graph.on('node:click', function (_ref3) {
      ...
      var node = _ref3.node;
      var canDelete = Object.keys(editor.graph.node.actives).length !== 0 || ((_editor$graph$line = editor.graph.line) === null || _editor$graph$line === void 0 ? void 0 : _editor$graph$line.activeLine);
      setCanDelete(canDelete);
    });
    editor.graph.on('node:unactive', function () {
      var _editor$graph$line2;
      var canDelete = Object.keys(editor.graph.node.actives).length !== 0 || ((_editor$graph$line2 = editor.graph.line) === null || _editor$graph$line2 === void 0 ? void 0 : _editor$graph$line2.activeLine);
      setCanDelete(canDelete);
    });
    editor.graph.on('paper:click', function () {
      var _editor$graph$line3;
      var canDelete = Object.keys(editor.graph.node.actives).length !== 0 || ((_editor$graph$line3 = editor.graph.line) === null || _editor$graph$line3 === void 0 ? void 0 : _editor$graph$line3.activeLine);
      setCanDelete(canDelete);
    });
  ...
  var getCommandChild = function getCommandChild(commandActions) {
    var child = [];
    commandActions === null || commandActions === void 0 ? void 0 : commandActions.forEach(function (type) {
      var click = null;
      ...
      if (type) {
        child.push( /*#__PURE__*/_react.default.createElement("span", {
          className: "".concat(getClassName(type), " command-item"),
          onClick: click || clickEvent(type)
        }, !['auto-fit', 'reset'].includes(type) && /*#__PURE__*/_react.default.createElement(_icon.default, {
          type: type
        }), ['auto-fit', 'reset'].includes(type) && /*#__PURE__*/_react.default.createElement("span", {
    ...
    }, "\u7EB5\u5411\u6392\u5E8F"), /*#__PURE__*/_react.default.createElement(_menu.default.Item, {
      onClick: function onClick() {
        return format('x');
      }
    }, "\u6A2A\u5411\u6392\u5E8F"));
    child.push( /*#__PURE__*/_react.default.createElement(_dropdown.default, {
      overlay: menu,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, previewMode && /*#__PURE__*/_react.default.createElement(_button.default.Group, {
    className: "flow-btn-wrap",
    size: "small"
  }, (_commandActions = commandActions) === null || _commandActions === void 0 ? void 0 : _commandActions.map(function (type) {
  ...
  }, /*#__PURE__*/_react.default.createElement("div", null, getCommandChild(commandActions)), operateGroup === null || operateGroup === void 0 ? void 0 : operateGroup.map(function (v) {
      ...
      onClick: function onClick() {
        ...
        if (data) {
          if ((v === null || v === void 0 ? void 0 : v.clickType) === 'async') {
            setLoad(_objectSpread(_objectSpread({}, load), {}, _defineProperty({}, v === null || v === void 0 ? void 0 : v.key, true)));
          }
          var vFun = v === null || v === void 0 ? void 0 : v.click(data);
          if ((v === null || v === void 0 ? void 0 : v.clickType) === 'async') {
            vFun === null || vFun === void 0 ? void 0 : vFun.finally(function () {
              setLoad(_objectSpread(_objectSpread({}, load), {}, _defineProperty({}, v === null || v === void 0 ? void 0 : v.key, false)));
            });
          }
        }
      }
