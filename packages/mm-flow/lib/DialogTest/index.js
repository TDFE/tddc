...
var _default = _form.default.create({
  ...
  var form = props.form,
    ...
    dmConfig = _props$dmConfig === void 0 ? {} : _props$dmConfig,
  ...
  var commitModal = function commitModal() {
    validateFields(function (errors, data) {
      if (!errors) {
        ...
        editor.graph.node.nodes[nodeId].shape.select('text.flow-txt-node').node.innerHTML = nodeName.length > 6 ? nodeName.substring(0, 6) + '...' : nodeName;
        onCancel();
      }
    });
  };
  var footerDom = [/*#__PURE__*/_react.default.createElement(_button.default, {
    onClick: onCancel,
    key: "cancel"
  ...
  var footerCancelDom = [/*#__PURE__*/_react.default.createElement(_button.default, {
    onClick: onCancel,
    key: "cancel"
  }, "\u5173\u95ED")];
  return /*#__PURE__*/_react.default.createElement(_modal.default, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_form.default, formItemLayout, /*#__PURE__*/_react.default.createElement(_form.default.Item, {
    label: "\u8282\u70B9\u540D\u79F0"
    ...
    id: 'fmk',
    name: '放光明'
  }]) === null || _ref5 === void 0 ? void 0 : _ref5.map(function (item) {
