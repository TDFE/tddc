...
var _default = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var checkNewLine = function checkNewLine(data, editor) {
    ...
    checkLineExtendFn && checkLineExtendFn({
      data: data,
      editor: editor
    });
    return true;
  ...
  (0, _react.useEffect)(function () {
    var resizeBound = function resizeBound() {
      var _ref3 = editorWrapRef && editorWrapRef.current && editorWrapRef.current.getBoundingClientRect() || {},
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return editorRef.current.schema.setInitData((_convertFun = convertFun) === null || _convertFun === void 0 ? void 0 : _convertFun.convert(dataFormatted, editorRef.current));
          case 6:
            _context2.next = 8;
          ...
          case 11:
            ...
            _message2.default.error('解析数据错误,' + (_context2.t0 === null || _context2.t0 === void 0 ? void 0 : _context2.t0.message));
          case 14:
          case "end":
  ...
  (0, _react.useEffect)(function () {
    if (autoDiffAuditNodes && editorRef.current && initReady && JSON.stringify(auditedNodes) !== JSON.stringify(auditedNodesPre === null || auditedNodesPre === void 0 ? void 0 : auditedNodesPre.current)) {
      setGraphData(graphData);
  ...
  var addEditorEvent = function addEditorEvent() {
    var timeStamp;
    // 选中
    editorRef === null || editorRef === void 0 ? void 0 : editorRef.current.graph.on('node:click', function (_ref6) {
      var _document$getElements, _document$getElements2;
      var node = _ref6.node;
      (_document$getElements = document.getElementsByClassName('lb-workflow-header')[0]) === null || _document$getElements === void 0 ? void 0 : (_document$getElements2 = _document$getElements.children[1]) === null || _document$getElements2 === void 0 ? void 0 : _document$getElements2.blur();
      var now = new Date().getTime();
      if (now - timeStamp < 300) {
        // 产品说这个情况下就不用弹窗
        !dialogHide && dialogHandleRef.current.show(node, editorRef === null || editorRef === void 0 ? void 0 : editorRef.current, function (data) {
    ...
    // 没有选中
    editorRef === null || editorRef === void 0 ? void 0 : editorRef.current.graph.on('node:mouseenter', function (_ref7) {
      var node = _ref7.node;
    ...
    editorRef === null || editorRef === void 0 ? void 0 : editorRef.current.graph.on('node:mouseleave', function () {
      setToolTipInfo(null);
    });

    // 节点删除事件
    editorRef === null || editorRef === void 0 ? void 0 : editorRef.current.graph.on('node:remove', function () {
      setToolTipInfo(null);
    });
  };
  ...
  var runFlow = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var _ref9, graph, _ref10, nodes, lines, hasAuditedNodeUuids, auditedLine, key, node, _key, line;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            if (auditedNodes === null || auditedNodes === void 0 ? void 0 : auditedNodes.length) {
              _context3.next = 2;
              break;
            }
            return _context3.abrupt("return");
          case 2:
            _ref9 = (editorRef === null || editorRef === void 0 ? void 0 : editorRef.current) || {}, graph = _ref9.graph;
            ...
            auditedNodes.forEach(function (hasAudited) {
              ...
              Object.values(nodes).forEach(function (node) {
                if (node.data.uuid === uuid) {
                  node.data.className = "".concat(node.data.className || '', " ").concat(status);
              ...
              for (var key in lines) {
                ...
                if (uuid === line.data.to && hasAuditedNodeUuids.indexOf(line.data.from) > -1) {
                  line.data.className = "".concat(line.data.className || '', "  ").concat(status);
  ...
  var onDrop = function onDrop(item, e) {
    ...
    // 增加节点
    var dom = editorRef === null || editorRef === void 0 ? void 0 : (_editorRef$current = editorRef.current) === null || _editorRef$current === void 0 ? void 0 : _editorRef$current.dom.node;
    var name = (item === null || item === void 0 ? void 0 : item.initName) || (item === null || item === void 0 ? void 0 : item.name);
    var _ref12 = item || {},
      _ref12$size = _ref12.size,
      size = _ref12$size === void 0 ? [] : _ref12$size;
    var transform = editorRef === null || editorRef === void 0 ? void 0 : editorRef.current.paper.transform();
    ...
    editorRef === null || editorRef === void 0 ? void 0 : (_editorRef$current2 = editorRef.current) === null || _editorRef$current2 === void 0 ? void 0 : _editorRef$current2.graph.node.addNode(Object.assign({}, item, {
  ...
  }, editorStyle), !previewMode && initReady && (editorRef === null || editorRef === void 0 ? void 0 : editorRef.current) && /*#__PURE__*/_react.default.createElement(_LeftBar.default, _extends({}, props, {
    editor: editorRef.current,
    onDrop: onDrop
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "job-content flow-editor-content"
  }, initReady && !!(editorRef === null || editorRef === void 0 ? void 0 : editorRef.current) && /*#__PURE__*/_react.default.createElement(_TopBar.default, _extends({}, props, {
    previewMode: previewMode,
    editor: editorRef.current
  })), /*#__PURE__*/_react.default.createElement("div", {
    className: "job-mm-editor",
    ref: editorDomRef
  }), !!showLengend && (LengendDom || /*#__PURE__*/_react.default.createElement(_row.default, {
    type: "flex",
    className: "mm-lengend"
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "success"
  }, /*#__PURE__*/_react.default.createElement("i", null), "\u8FD0\u884C\u5B8C\u6210"), /*#__PURE__*/_react.default.createElement("span", {
    className: "running"
  }, /*#__PURE__*/_react.default.createElement("i", null), "\u8FD0\u884C\u4E2D"), /*#__PURE__*/_react.default.createElement("span", {
    className: "fail"
  }, /*#__PURE__*/_react.default.createElement("i", null), "\u8FD0\u884C\u5931\u8D25")))), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      position: 'fixed',
      ...
      display: (toolTipInfo === null || toolTipInfo === void 0 ? void 0 : toolTipInfo.textVisible) ? 'block' : 'none'
    }
  }, /*#__PURE__*/_react.default.createElement(_tooltip.default, {
    visible: true,
    title: "".concat(toolTipInfo === null || toolTipInfo === void 0 ? void 0 : (_toolTipInfo$nowTextN = toolTipInfo.nowTextNode) === null || _toolTipInfo$nowTextN === void 0 ? void 0 : _toolTipInfo$nowTextN.name)
  })), dialogDom === null || dialogDom === void 0 ? void 0 : dialogDom.map(function (dialog) {
    return /*#__PURE__*/_react.default.cloneElement(dialog, _objectSpread(_objectSpread({}, props), {}, {
