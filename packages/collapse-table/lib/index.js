...
var CollapseTable = function CollapseTable(props) {
  ...
  var trigger = function trigger(className) {
    ...
    var dom = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector(".".concat(className, ".ant-table-wrapper.collapse-panel > .ant-spin-nested-loading > .ant-spin-container > .ant-table"));
    dom === null || dom === void 0 ? void 0 : dom.setAttribute('c-data', 'Mutation');
  };
  var expand = function expand() {
    var main = document.querySelector(".".concat(randomCode.current, " .ant-table-scroll [data-row-key=\"").concat(activeKeyRef.current, "-extra-row\"]"));
    var right = document.querySelector(".".concat(randomCode.current, " .ant-table-fixed-right [data-row-key=\"").concat(activeKeyRef.current, "-extra-row\"]"));
    var left = document.querySelector(".".concat(randomCode.current, " .ant-table-fixed-left [data-row-key=\"").concat(activeKeyRef.current, "-extra-row\"]"));
    console.log(1);
    if (right) {
      right.setAttribute('style', "display: inline-block; height: ".concat(main.offsetHeight || 0, "px; overflow: hidden;"));
    }
    if (left) {
      left.setAttribute('style', "display: inline-block; height: ".concat(main.offsetHeight || 0, "px; overflow: hidden;"));
    }
  };
    ...
    if (expanded) {
      return /*#__PURE__*/_react.default.createElement("span", {
        ...
        onClick: function onClick(e) {
          ...
          if (props === null || props === void 0 ? void 0 : props.onExpand) props === null || props === void 0 ? void 0 : props.onExpand(p.expanded, p.record);
        }
  ...
  var expandIconColumnIndex = (props === null || props === void 0 ? void 0 : props.rowSelection) ? 1 : props.expandIconColumnIndex || 0; // 确定checkbox框位置
  // 设置expandIcon的默认值
