...
var exclusiveDays = dayOfMonthList.filter(function (d) {
  return d.exclusive;
}).map(function (d) {
  return d.value;
});
...
var cornFormat = function cornFormat(corn, mode, isRange) {
  ...
  return {
    ...
    stringValue: value,
    ss: parseInt(ss) || 0,
    mm: freq === 'everyHours' && !!mode ? mm.split(',').filter(function (i) {
      return !!i;
    }) : parseInt(mm) || 0,
    HH: HH || 0,
...
var cornStringify = function cornStringify(_ref) {
  ...
  return "".concat(ss, " ").concat(mm, " ").concat(HH, " ").concat(dd, " ").concat(MM, " ").concat(week, " ").concat(yyyy);
};
var validCron = function validCron(value, multiple, isRange) {
  var cronObj = cornFormat(value, multiple, isRange);
  if (isRange) {
    var _cronObj$HH;
    var arr = ((_cronObj$HH = cronObj.HH) === null || _cronObj$HH === void 0 ? void 0 : _cronObj$HH.split('-')) || [];
...
function CronForm(_ref2) {
  ...
  var onFreqChanged = (0, _react.useCallback)(function (freq) {
    setObjValue(function (oldObj) {
      var newObj = _objectSpread(_objectSpread(_objectSpread({}, oldObj), {}, {
        freq: freq,
        week: freq === 'week' ? ['1'] : [],
  ...
  var onMonthOfYearChanged = (0, _react.useCallback)(function (MM) {
    setObjValue(function (oldObj) {
      var newObj = _objectSpread(_objectSpread({}, oldObj), {}, {
        MM: MM
      });
      changeValue(newObj);
      return newObj;
  ...
  var onFreqTimeChanged = (0, _react.useCallback)(function (time) {
    ...
    setObjValue(function (oldObj) {
      ...
      var hhArr = oldHH === null || oldHH === void 0 ? void 0 : (_oldHH$toString = oldHH.toString()) === null || _oldHH$toString === void 0 ? void 0 : _oldHH$toString.split('-');
      if (!isEnd) {
  ...
  if (isRange) {
    var _HH$toString;
    var hhArr = HH === null || HH === void 0 ? void 0 : (_HH$toString = HH.toString()) === null || _HH$toString === void 0 ? void 0 : _HH$toString.split('-');
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_select.default, {
  ...
  })), isYear && /*#__PURE__*/_react.default.createElement(_select.default, {
    value: MM,
  ...
  })), (isYear || isMonth) && /*#__PURE__*/_react.default.createElement(_select.default, {
    value: dd,
  ...
  })), isWeek && /*#__PURE__*/_react.default.createElement(_select.default, {
    value: week,
  ...
  })), isHours && /*#__PURE__*/_react.default.createElement(_select.default, {
    value: mm,
  ...
  })), !isHours && !isCustom && (isRange ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_timePicker.default, {
    ...
    format: timeFormat,
    showNow: false
  })), isCustom && /*#__PURE__*/_react.default.createElement(_input.default, {
    style: width150,
    value: stringValue,
