...
var ReferenceBatchCheck = function ReferenceBatchCheck(props) {
  var _ref = props || {},
    ...
    }), (0, _locale.getText)('onLineFail', props === null || props === void 0 ? void 0 : props.lang)) : _ref$title,
    rq = _ref.rq,
  ...
  var appendModal = function appendModal(reject, resolve) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_tntd.Modal, {
      ...
      type: "warning",
      message: weakMsg || ((_referenceData4 = referenceData) === null || _referenceData4 === void 0 ? void 0 : _referenceData4.message) || (0, _locale.getText)('weakMsg', props === null || props === void 0 ? void 0 : props.lang)
      // '存在弱引用（被下线、禁用、待提交/上线、导入待提交/上线、暂存、保存等相关状态组件引用）关系，谨慎操作'
    })), !canNextOpera && /*#__PURE__*/_react.default.createElement("div", {
      className: "mb10"
    }, /*#__PURE__*/_react.default.createElement(_alert.default, {
      type: "error",
      message: strongMsg || ((_referenceData5 = referenceData) === null || _referenceData5 === void 0 ? void 0 : _referenceData5.message) || (0, _locale.getText)('strongMsg', props === null || props === void 0 ? void 0 : props.lang)
      // '存在强引用（被上线、启用、上下线审批中和指标初始化等相关状态组件引用）关系，禁止操作'
    })), /*#__PURE__*/_react.default.createElement(_collapse.default, {
      defaultActiveKey: value || [0],
      onChange: onChange
    }, (_referenceData6 = referenceData) === null || _referenceData6 === void 0 ? void 0 : _referenceData6.map(function (d, i) {
      ...
      return /*#__PURE__*/_react.default.createElement(Panel, {
        header: /*#__PURE__*/_react.default.createElement("div", {
          ...
          color: "green"
        }, "V", d === null || d === void 0 ? void 0 : d.componentVersion), (d === null || d === void 0 ? void 0 : d.type) === 'STRONG' && /*#__PURE__*/_react.default.createElement(_tag.default, {
          color: "#D96156"
        }, (0, _locale.getText)('exist', props === null || props === void 0 ? void 0 : props.lang), (d === null || d === void 0 ? void 0 : d.typeName) || (0, _locale.getText)('strong', props === null || props === void 0 ? void 0 : props.lang))),
        key: i
