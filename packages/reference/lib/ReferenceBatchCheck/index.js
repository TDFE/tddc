...
var ReferenceBatchCheck = function ReferenceBatchCheck(props) {
  var _ref = props || {},
    ...
    style: {
      ...
      strongMsg = _ref$strongMsg === void 0 ? '存在强引用（被上线、启用、上下线审批中和指标初始化等相关状态组件引用）关系，禁止操作' : _ref$strongMsg;
  ...
  var appendModal = function appendModal(reject, resolve) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_tntd.Modal, {
      ...
      footer: [/*#__PURE__*/_react.default.createElement(_button.default, {
        key: "back",
        onClick: removeModal
      }, "\u53D6\u6D88"), canNextOpera && /*#__PURE__*/_react.default.createElement(_button.default, {
        key: "submit",
        type: "primary",
      ...
      type: "warning",
      message: weakMsg || ((_referenceData4 = referenceData) === null || _referenceData4 === void 0 ? void 0 : _referenceData4.message) || '存在弱引用（被下线、禁用、待提交/上线、导入待提交/上线、暂存、保存等相关状态组件引用）关系，谨慎操作'
    })), !canNextOpera && /*#__PURE__*/_react.default.createElement("div", {
      className: "mb10"
    }, /*#__PURE__*/_react.default.createElement(_alert.default, {
      type: "error",
      message: strongMsg || ((_referenceData5 = referenceData) === null || _referenceData5 === void 0 ? void 0 : _referenceData5.message) || '存在强引用（被上线、启用、上下线审批中和指标初始化等相关状态组件引用）关系，禁止操作'
      ...
      return /*#__PURE__*/_react.default.createElement(Panel, {
        header: /*#__PURE__*/_react.default.createElement("div", {
          ...
          color: "#D96156"
        }, "\u5B58\u5728", (d === null || d === void 0 ? void 0 : d.typeName) || '强引用')),
        key: i
