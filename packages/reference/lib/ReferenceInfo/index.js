...
var ReferenceInfo = function ReferenceInfo(props) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, !(referenceData === null || referenceData === void 0 ? void 0 : referenceData.length) && /*#__PURE__*/_react.default.createElement(_empty.default, {
    description: description || (0, _locale.getText)('noData', props === null || props === void 0 ? void 0 : props.lang),
    ...
    if (columns === null || columns === void 0 ? void 0 : columns.length) {
      renderColumns = columns === null || columns === void 0 ? void 0 : columns.map(function (c, i) {
        ...
        var fixedWidthLimit = {};
        var fixedMaxWidth = {};
        if (i === (columns === null || columns === void 0 ? void 0 : columns.length) - 1) {
        ...
        newC.render = function (t, record) {
          ...
          if (c.dataIndex === 'org') {
            var _orgMap$t;
            content = ((_orgMap$t = orgMap[t]) === null || _orgMap$t === void 0 ? void 0 : _orgMap$t.name) || t;
          }
          if (c.dataIndex === 'app') {
            var _appList$find;
            content = ((_appList$find = appList.find(function (a) {
              return a.key === t;
            })) === null || _appList$find === void 0 ? void 0 : _appList$find.name) || t;
          }
          // 强弱引用
          var tagInfo = null;
          if (i === 0 && (record === null || record === void 0 ? void 0 : record.referenceCheckType)) {
            ...
            if (isStrong) {
              checkObj = {
                name: (record === null || record === void 0 ? void 0 : record.referenceCheckTypeName) || (0, _locale.getText)('strong', props === null || props === void 0 ? void 0 : props.lang),
                className: 'refer-tag-strong'
              };
            } else {
              checkObj = {
                name: (record === null || record === void 0 ? void 0 : record.referenceCheckTypeName) || (0, _locale.getText)('weak', props === null || props === void 0 ? void 0 : props.lang),
                className: 'refer-tag-weak'
              };
            }
            tagInfo = checkObj ? /*#__PURE__*/_react.default.createElement("span", {
          ...
          if (c.dataIndex === goName) {
            return /*#__PURE__*/_react.default.createElement(_tntd.Ellipsis, _extends({
              placement: "topLeft",
              copyable: true
            }, fixedWidthLimit, {
              title: content || '- -',
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      placement: "topLeft"
    }, d === null || d === void 0 ? void 0 : d.title)), (d === null || d === void 0 ? void 0 : d.tips) && /*#__PURE__*/_react.default.createElement(_tooltip.default, {
      title: d === null || d === void 0 ? void 0 : d.tips,
      placement: "topLeft"
    }, /*#__PURE__*/_react.default.createElement(_icon.default, {
      type: "info-circle",
      className: "ml-6"
    }))), ((_renderColumns = renderColumns) === null || _renderColumns === void 0 ? void 0 : _renderColumns.length) && /*#__PURE__*/_react.default.createElement(_table.default, {
