...
var ReferenceCheck = function ReferenceCheck(props) {
  ...
  var appendModal = function appendModal(resolve, _ref2) {
    ...
    _reactDom.default.render( /*#__PURE__*/_react.default.createElement(_tntd.Modal, {
      ...
      type: "warning",
      message: weakMsg || (referenceData === null || referenceData === void 0 ? void 0 : referenceData.message) || '存在弱引用（被下线、禁用、待提交/上线、导入待提交/上线、暂存、保存等相关状态组件引用）关系，谨慎操作'
    })), !canNextOpera && /*#__PURE__*/_react.default.createElement("div", {
      className: "mb10"
    }, /*#__PURE__*/_react.default.createElement(_alert.default, {
      type: "error",
      message: strongMsg || (referenceData === null || referenceData === void 0 ? void 0 : referenceData.message) || '存在强引用（被上线、启用、上下线审批中和指标初始化等相关状态组件引用）关系，禁止操作'
    })), /*#__PURE__*/_react.default.createElement("div", {
