...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } // import conditionOperator from '../constants';
...
var OneCondition = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(OneCondition, [{
    ...
    value: function addCondition() {
      ...
      newAllCondition[conditionArr[0]]['children'].splice(conditionArr[1] + 1, 0, singleConditionTemp);
    ...
    value: function changeConditionField(field, type, e) {
      ...
      if (currentLine['propertyDataType'] === 'ENUM' || currentLine['propertyDataType'] === 'BOOLEAN') {
      ...
      if (conditionArr.length === 1) {
        newAllCondition[conditionArr[0]] = _objectSpread(_objectSpread({}, newAllCondition[conditionArr[0]]), currentLine);
        setCondition(newAllCondition);
      } else if (conditionArr.length === 2) {
        // 如果是条件组
        newAllCondition[conditionArr[0]]['children'][conditionArr[1]] = _objectSpread(_objectSpread({}, newAllCondition[conditionArr[0]]['children'][conditionArr[1]]), currentLine);
        setCondition(newAllCondition);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var operaTypeInOrNot = conditionSingleData['op'] === 'in' || conditionSingleData['op'] === 'notin';
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: "".concat(conditionType === 'group' ? 'group-item' : '', " condition-group-item")
      }, (conditionArr[1] === 0 || !conditionArr[1]) && /*#__PURE__*/_react.default.createElement(_col.default, {
        style: style
      }, /*#__PURE__*/_react.default.createElement("span", {
        className: "letters"
      }, conditionArr[0] + 1)), conditionType === 'group' && conditionArr[1] === 0 && /*#__PURE__*/_react.default.createElement(_col.default, {
        ...
        value: "&&",
        title: '与'
      }, '与'), /*#__PURE__*/_react.default.createElement(Option, {
        value: "||",
        title: '或'
      }, '或'))), conditionType === 'group' && /*#__PURE__*/_react.default.createElement("div", {
        ...
        onChange: /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(value, selectObj) {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  _context.next = 6;
                  return _this2.changeConditionField('enumTypeValues', 'select', enumTypeValues || name);
                case 6:
        ...
        setTitle: function setTitle() {
          ...
          var isLink = false;
          var value = conditionSingleData === null || conditionSingleData === void 0 ? void 0 : conditionSingleData.property;
          isLink = (value === null || value === void 0 ? void 0 : value.includes('offlinezb')) || (value === null || value === void 0 ? void 0 : value.includes('salaxyzb'));
          var dom = option;
          var tab = option && ((_option$0$props = option[0].props) === null || _option$0$props === void 0 ? void 0 : (_option$0$props$data = _option$0$props.data) === null || _option$0$props$data === void 0 ? void 0 : _option$0$props$data.metricArea) === 'EDIT' ? 2 : 1;
          if (isLink) {
            var text = option[1];
            var url = value.includes('offlinezb') ? "/index/offIndexManage?currentTab=".concat(tab, "&featureSetName=").concat(text) : "/index/realtime?currentTab=".concat(tab, "&metricName=").concat(text);
            dom = /*#__PURE__*/_react.default.createElement("a", {
              className: "link-zb",
        ...
        value: conditionSingleData && conditionSingleData['op'] ? conditionSingleData['op'] : undefined,
        placeholder: "\u8BF7\u9009\u62E9",
        onChange: this.changeConditionField.bind(this, 'op', 'select'),
        dropdownMatchSelectWidth: false
      }, conditionOperator[(conditionSingleData === null || conditionSingleData === void 0 ? void 0 : conditionSingleData.propertyDataType) ? conditionSingleData === null || conditionSingleData === void 0 ? void 0 : conditionSingleData.propertyDataType.toUpperCase() : 'STRING'].map(function (item, index) {
        return /*#__PURE__*/_react.default.createElement(Option, {
          value: item.name,
          key: index,
          title: item.dName
        }, item.dName);
      })))), conditionSingleData && conditionSingleData['op'] && conditionSingleData['op'] !== 'isnull' && conditionSingleData['op'] !== 'notnull' && /*#__PURE__*/_react.default.createElement(_col.default, {
        className: "gutter-row",
        style: {
          width: 375
        }
        ...
        className: "gutter-box"
      }, conditionSingleData['rightValueType'] === 'input' && leftOptionDataType === 'ENUM' && /*#__PURE__*/_react.default.createElement(InputGroup, {
        compact: true
      }, /*#__PURE__*/_react.default.createElement(_select.default, {
        ...
        value: "input",
        title: '常量'
      }, '常量'), /*#__PURE__*/_react.default.createElement(Option, {
        value: "context",
        title: '变量'
      }, '变量')), leftOptionDataType === 'BOOLEAN' && /*#__PURE__*/_react.default.createElement(_select.default, {
        style: {
          width: '70%'
        },
        ...
        value: "true"
      }, '是[true]'), /*#__PURE__*/_react.default.createElement(Option, {
        value: "false"
      }, '否[false]')) || /*#__PURE__*/_react.default.createElement(_select.default, {
      ...
      }, conditionSingleData && ((_conditionSingleData$ = conditionSingleData['enumTypeValues']) === null || _conditionSingleData$ === void 0 ? void 0 : _conditionSingleData$.map(function (item, index) {
        return /*#__PURE__*/_react.default.createElement(Option, {
          value: item.value,
          key: index,
          title: "".concat(item.description, " [").concat(item.value, "]")
        ...
        value: "false"
      }, '否[false]')) || /*#__PURE__*/_react.default.createElement(_input.default, {
        style: {
          width: '70%'
        },
        value: conditionSingleData && conditionSingleData['value'] ? conditionSingleData['value'] : undefined,
        placeholder: customPlaceholder || (operaTypeInOrNot ? '英文逗号分隔，例如1,2' : '请输入常量内容') // 请输入常量内容
        ,
        onChange: this.changeConditionField.bind(this, 'value', 'input')
      })), conditionSingleData && conditionSingleData['rightValueType'] === 'context' && leftOptionDataType !== 'ENUM' && /*#__PURE__*/_react.default.createElement(InputGroup, {
        compact: true
      }, /*#__PURE__*/_react.default.createElement(_select.default, {
        value: conditionSingleData && conditionSingleData['rightValueType'] ? conditionSingleData['rightValueType'] : undefined,
        style: {
        ...
        value: "context",
        title: '变量'
      }, '变量')), /*#__PURE__*/_react.default.createElement(_virtualCascader.default, {
        style: {
          width: '70%'
        },
        ...
        setTitle: function setTitle() {
          ...
          isLink = (value === null || value === void 0 ? void 0 : value.includes('offlinezb')) || (value === null || value === void 0 ? void 0 : value.includes('salaxyzb'));
          var dom = option;
          var tab = option && ((_option$0$props2 = option[0].props) === null || _option$0$props2 === void 0 ? void 0 : (_option$0$props2$data = _option$0$props2.data) === null || _option$0$props2$data === void 0 ? void 0 : _option$0$props2$data.metricArea) === 'EDIT' ? 2 : 1;
          if (isLink) {
            var text = option[1];
            var url = value.includes('offlinezb') ? "/index/offIndexManage?currentTab=".concat(tab, "&featureSetName=").concat(text) : "/index/realtime?currentTab=".concat(tab, "&metricName=").concat(text);
            dom = /*#__PURE__*/_react.default.createElement("a", {
        ...
        setTitle: function setTitle() {
          ...
          var option = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
          var isLink = false;
          var value = conditionSingleData === null || conditionSingleData === void 0 ? void 0 : conditionSingleData.value;
          isLink = (value === null || value === void 0 ? void 0 : value.includes('offlinezb')) || (value === null || value === void 0 ? void 0 : value.includes('salaxyzb'));
          var dom = option;
          var tab = option && ((_option$0$props3 = option[0].props) === null || _option$0$props3 === void 0 ? void 0 : (_option$0$props3$data = _option$0$props3.data) === null || _option$0$props3$data === void 0 ? void 0 : _option$0$props3$data.metricArea) === 'EDIT' ? 2 : 1;
          if (isLink) {
            var text = option[1];
            var url = value.includes('offlinezb') ? "/index/offIndexManage?currentTab=".concat(tab, "&featureSetName=").concat(text) : "/index/realtime?currentTab=".concat(tab, "&metricName=").concat(text);
            dom = /*#__PURE__*/_react.default.createElement("a", {
      ...
      })), !disabled && /*#__PURE__*/_react.default.createElement(_tooltip.default, {
        title: '删除当前行',
        placement: "right"
      }, /*#__PURE__*/_react.default.createElement(_icon.default, {
        className: "delete",
