...
var RuleConditon = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function RuleConditon(props) {
    ...
    _this.getChildOption = function () {
      ...
      var childOption = list === null || list === void 0 ? void 0 : list.reduce(function (total, item) {
        // 获取转换后的数据类型
        var _dataTypeSpecialConve = (0, _index.dataTypeSpecialConvert)(item),
          convertDataType = _dataTypeSpecialConve.type;
        if (Array.isArray(total === null || total === void 0 ? void 0 : total[convertDataType])) {
      ...
      if (NOEnumChildOption['ENUM']) {
        NOEnumChildOption['ENUM'] = NOEnumChildOption['ENUM'].concat(NOEnumChildOption['STRING'] || []);
      }
  ...
  _createClass(RuleConditon, [{
    ...
    value: function changeAfterAddPriority(value) {
      ...
      var tempValue = value;
      var priority = 1;
      tempValue === null || tempValue === void 0 ? void 0 : (_tempValue$children = tempValue.children) === null || _tempValue$children === void 0 ? void 0 : _tempValue$children.map(function (item) {
        var _item$children;
        item.priority = priority++;
        item === null || item === void 0 ? void 0 : (_item$children = item.children) === null || _item$children === void 0 ? void 0 : _item$children.map(function (item1) {
    ...
    value: function render() {
      ...
      _react.default.createElement(_row.default, {
        ...
        value: conditionData && conditionData['logicOperator'] ? conditionData['logicOperator'] : null,
        disabled: disabled
      }, /*#__PURE__*/_react.default.createElement(_radio.default, {
        value: "&&"
      }, '满足以下所有条件'), /*#__PURE__*/_react.default.createElement(_radio.default, {
        value: "||"
      }, '满足以下任意条件'), mode === 3 && /*#__PURE__*/_react.default.createElement(_radio.default, {
        value: "!||"
      }, '以下条件均不满足'), /*#__PURE__*/_react.default.createElement(_radio.default, {
        value: "##"
      }, '自定义'))), /*#__PURE__*/_react.default.createElement(_col.default, {
        span: 2
      })), /*#__PURE__*/_react.default.createElement(_row.default, {
        gutter: 10
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: "custom-condition"
      }, conditionData && conditionData.type !== 'alias' && conditionData.children && conditionData.children.map(function (item, index) {
        if (item.type !== 'alias') {
          if ((item === null || item === void 0 ? void 0 : item.children) && (item === null || item === void 0 ? void 0 : item.children.length)) {
            return /*#__PURE__*/_react.default.createElement("div", {
              className: "custom-condition-item group-condition has-line group-index".concat(index),
              key: index
                      ...
                      while (1) switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          return _this2.setState({
                            conditionData: _objectSpread(_objectSpread({}, conditionData), {}, {
                              children: item || []
                            })
                          });
                        case 2:
                        ...
                        case 4:
                          ...
                          _this2.changeAfterAddPriority(_objectSpread(_objectSpread({}, conditionData), {}, {
                            children: item || []
                          }));
                        case 7:
                        case "end":
      ...
      }, '添加单条条件'), /*#__PURE__*/_react.default.createElement("a", {
        onClick: this.addGroupCondition.bind(this)
      }, '添加条件组'))), /*#__PURE__*/_react.default.createElement(_CustomRule.default, {
