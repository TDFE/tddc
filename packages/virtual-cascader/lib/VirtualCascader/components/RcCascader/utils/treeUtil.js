...
function formatStrategyValues(pathKeys, getKeyPathEntities, showCheckedStrategy) {
  ...
  return pathKeys.filter(function (key) {
    ...
    return showCheckedStrategy === _commonUtil.SHOW_CHILD
      ? !(
          children &&
...
function toPathOptions(valueCells, options, fieldNames) {
  ...
  var _loop = function _loop(i) {
    ...
    valueOptions.push({
      value:
        (_foundOption$fieldNam =
          foundOption === null || foundOption === void 0
            ? void 0
            : foundOption[fieldNames.value]) !== null && _foundOption$fieldNam !== void 0
          ? _foundOption$fieldNam
          : valueCell,
      index: foundIndex,
      option: foundOption,
    ...
    currentList =
      foundOption === null || foundOption === void 0 ? void 0 : foundOption[fieldNames.children];
  };
