...
var RefOptionList = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var emptyList = [
    ((_ref3 = {}),
    (0, _defineProperty2.default)(_ref3, fieldNames.value, '__EMPTY__'),
    (0, _defineProperty2.default)(_ref3, _Column.FIX_LABEL, notFoundContent),
    (0, _defineProperty2.default)(_ref3, 'disabled', true),
    _ref3),
  ];
  var columnProps = (0, _objectSpread2.default)(
  ...
  return /*#__PURE__*/ React.createElement(
    'div',
    {
      className: (0, _classnames.default)(
        ...
        (0, _defineProperty2.default)(_classNames, ''.concat(mergedPrefixCls, '-rtl'), rtl),
        _classNames),
      ),
      ref: containerRef,
    },
