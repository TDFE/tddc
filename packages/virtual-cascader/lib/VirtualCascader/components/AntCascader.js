  ...
  function CustomCascader(_props) {
    ...
    _this.renderCascader = function (_ref, locale) {
      ...
      var customizePrefixCls = props.prefixCls,
        ...
        placeholder =
          _props$placeholder === void 0
            ? locale.placeholder || 'Please select'
            : _props$placeholder,
        size = props.size,
      ...
      var sizeCls = (0, _classnames.default)(
        ((_classNames = {}),
        _defineProperty(_classNames, ''.concat(inputPrefixCls, '-lg'), size === 'large'),
        _defineProperty(_classNames, ''.concat(inputPrefixCls, '-sm'), size === 'small'),
        _classNames),
      );
      var clearIcon =
        (allowClear && !disabled && value.length > 0) || state.inputValue
          ...
          : null;
      var arrowCls = (0, _classnames.default)(
        ((_classNames2 = {}),
        _defineProperty(_classNames2, ''.concat(prefixCls, '-picker-arrow'), true),
        _defineProperty(
          _classNames2,
          ''.concat(prefixCls, '-picker-arrow-expand'),
          state.popupVisible,
        ),
        _classNames2),
      );
      var pickerCls = (0, _classnames.default)(
        className,
        ''.concat(prefixCls, '-picker'),
        ((_classNames3 = {}),
        _defineProperty(_classNames3, ''.concat(prefixCls, '-picker-with-value'), state.inputValue),
        _defineProperty(_classNames3, ''.concat(prefixCls, '-picker-disabled'), disabled),
        _defineProperty(_classNames3, ''.concat(prefixCls, '-picker-').concat(size), !!size),
      ...
      if (options && options.length > 0) {
        ...
        options = [
          ...
          _defineProperty(_ref2, names.label, notFoundContent || renderEmpty('Cascader')),
          _defineProperty(_ref2, 'disabled', true),
      ...
      var inputIcon =
        (suffixIcon &&
          ...
          suffixIcon
            ? /*#__PURE__*/ React.cloneElement(suffixIcon, {
                className: (0, _classnames.default)(
                  _defineProperty({}, ''.concat(prefixCls, '-picker-arrow'), true),
                ),
              })
            : /*#__PURE__*/ React.createElement(
                'span',
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        _extends({}, rest, {
          ...
          dropdownRender: function dropdownRender() {
            return _dropdownRender(state.inputValue, options);
          },
        }),
        input,
      );
    ...
    _this.state = {
      ...
      flattenOptions: _props.showSearch ? flattenTree(_props.options, _props) : undefined,
      prevProps: _props,
    };
    return _this;
  }
    ...
    [
      {
        ...
        value: function getLabel() {
          var _this$props = this.props,
            ...
            displayRender =
              _this$props$displayRe === void 0 ? defaultDisplayRender : _this$props$displayRe;
          var names = getFilledFieldNames(this.props);
          var _this$state2 = this.state,
            value = _this$state2.value,
            inputValue = _this$state2.inputValue;
          var unwrappedValue = Array.isArray(value[0]) ? value[0] : value;
          var selectedOptions = (0, _arrayTreeFilter.default)(
            options,
            function (o, level) {
      ...
      },
      {
        ...
        value: function generateFilteredOptions(prefixCls, renderEmpty) {
          ...
          var _showSearch$filter = showSearch.filter,
            ...
            render =
              _showSearch$render === void 0 ? defaultRenderFilteredOption : _showSearch$render,
          ...
          if (filtered.length > 0) {
            return filtered.map(function (path) {
              ...
              return (
                ...
                _defineProperty(_ref3, names.label, render(inputValue, path, prefixCls, names)),
                _defineProperty(
                  _ref3,
                  'disabled',
                  path.some(function (o) {
                    return !!o.disabled;
                  }),
                ),
                _defineProperty(_ref3, 'isEmptyNode', true),
                _ref3
              );
            });
          }
          return [
            ...
            _defineProperty(_ref4, names.label, notFoundContent || renderEmpty('Cascader')),
            _defineProperty(_ref4, 'disabled', true),
            _defineProperty(_ref4, 'isEmptyNode', true),
            _ref4),
          ];
        },
      },
...
(0, _reactLifecyclesCompat.polyfill)(CustomCascader);
var _default = CustomCascader;
