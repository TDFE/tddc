...
var Cascader = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var deDuplicatedValues = React.useMemo(
    function () {
      ...
      return [].concat(
        (0, _toConsumableArray2.default)(missingCheckedValues),
        (0, _toConsumableArray2.default)(getValueByKeyPath(deduplicateKeys)),
      );
    },
    [
      checkedValues,
  ...
  var onInternalSelect = (0, _useRefFunc.default)(function (valuePath) {
    ...
    if (!multiple) {
      ...
      triggerChange(
        [].concat(
          (0, _toConsumableArray2.default)(nextMissingValues),
          (0, _toConsumableArray2.default)(nextCheckedValues),
        ),
      );
    }
  });
