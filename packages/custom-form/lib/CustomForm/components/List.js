...
var List = function List(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _dataSource;
        var key = _step.value;
        dataSource = ((_dataSource = dataSource) === null || _dataSource === void 0 ? void 0 : _dataSource[key]) || [{}];
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, children === null || children === void 0 ? void 0 : children(dataLevel, {
    add: handleAdd,
    remove: handleDel
  }));
};
