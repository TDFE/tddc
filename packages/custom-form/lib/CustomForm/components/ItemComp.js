...
var ItemComp = function ItemComp(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (name) {
      var _getNames;
      setCurrentChangeKeys([(_getNames = (0, _utils.getNames)(name)) === null || _getNames === void 0 ? void 0 : _getNames.join('.')]);
    }
  }, []);
  /**
  ...
  var handleChange = function handleChange(e) {
    ...
    if (_typeof(e) === 'object') {
      var _e$target;
      val = e === null || e === void 0 ? void 0 : (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.value;
    } else {
      val = e;
    }
    setValue(val);
    ...
    if (name) {
      var _getNames2;
      setCurrentChangeKeys([(_getNames2 = (0, _utils.getNames)(name)) === null || _getNames2 === void 0 ? void 0 : _getNames2.join('.')]);
    }
  };
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    if ( /*#__PURE__*/_react.default.isValidElement(child)) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(child, _objectSpread({
        ...
        'data-key': (_getNames3 = (0, _utils.getNames)(name)) === null || _getNames3 === void 0 ? void 0 : _getNames3.join('.')
      }, child.props));
    }
    return null;
...
function arePropsEqual(prevProps, nextProps) {
  if (Array.isArray(nextProps.currentChangeKeys) && nextProps.currentChangeKeys.length && (0, _lodash.isEqual)(prevProps.initialValues, nextProps.initialValues) && !nextProps.currentChangeKeys.includes((0, _utils.getNames)(nextProps.name).join('.')) && !nextProps.shouldUpdate && Array.isArray(nextProps.dependencies) && nextProps.dependencies.every(function (i) {
    var _nextProps$currentCha;
    return !((_nextProps$currentCha = nextProps.currentChangeKeys) === null || _nextProps$currentCha === void 0 ? void 0 : _nextProps$currentCha.includes((0, _utils.getNames)(i).join('.')));
  })) {
    return true;
  }
  return false;
