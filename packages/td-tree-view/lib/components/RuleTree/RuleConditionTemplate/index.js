...
var RuleConditionTemplate = function RuleConditionTemplate(props) {
  ...
  property && _constants.excludeRuleTemplate.includes(property) && /*#__PURE__*/_react.default.createElement(_CustomRuleConfig.default, {
    ...
    lang: lang
  }), property && !_constants.excludeRuleTemplate.includes(property) && cfgJson.params && cfgJson.params.map(function (item, index) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, currentTemplate && currentTemplate.description && /*#__PURE__*/_react.default.createElement(_tntd.Popover, {
    content: dom,
