...
var OneCondition = function OneCondition(props) {
  ...
  var textDom = /*#__PURE__*/_react.default.createElement("span", {
  ...
  }, conditionType === 'group' && "".concat(Number(conditionArr[0]) + 1, ".").concat(Number(conditionArr[1]) + 1, ". "), /*#__PURE__*/_react.default.createElement("span", {
    className: "condition-value"
    ...
    className: "condition-op"
  }, ifAppendIsStr && (lang === 'en' ? ' is ' : '为')), rightValueType === 'input' && propertyDataType !== 'ENUM' && !operaTypeBlong && /*#__PURE__*/_react.default.createElement("span", {
    className: "condition-value"
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, conditionType === 'group' && conditionArr[1] === 0 && /*#__PURE__*/_react.default.createElement("div", null, '条件关系：&nbsp;', logicOperatorMap[logicOperator] || logicOperator), /*#__PURE__*/_react.default.createElement(_tooltip.default, {
    title: textDom,
    placement: "topLeft",
