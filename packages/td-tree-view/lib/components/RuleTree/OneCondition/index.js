...
var OneCondition = function OneCondition(props) {
  ...
  if (property && ruleAndIndexFieldList && ruleAndIndexFieldList.length) {
    // 获取左侧属性显示名称
    propertyName = ruleAndIndexFieldList.find(function (v) {
      return v.name === property;
    }) || {};
    propertyName = propertyName && propertyName.dName ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      data: propertyName
    }), propertyName.dName) : property;
    // 枚举值
    // enumField = (
  ...
  var getContextNotEnumName = function getContextNotEnumName() {
    var valueObj = ruleAndIndexFieldList.filter(function (fItem) {
      return fItem.type && (fItem.type === propertyDataType || ['DOUBLE', 'INT'].includes(fItem.type) && ['DOUBLE', 'INT'].includes(propertyDataType));
    }).find(function (v) {
      return v.name === value;
    }) || {};
    return /*#__PURE__*/_react.default.createElement("span", {
      className: "condition-type"
    }, /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      data: valueObj
    }), valueObj.dName) || value);
  };
  ...
  var getEnumNotBlongName = function getEnumNotBlongName() {
    ...
    if (conditionSingleData['enumTypeValues'].length) {
      enumObj = conditionSingleData['enumTypeValues'].find(function (item) {
  ...
  var getEnumInOrNotInName = function getEnumInOrNotInName() {
    ...
    var enumArr = [];
    var enumTypeValues = ((_ruleAndIndexFieldLis = ruleAndIndexFieldList.find(function (item) {
      return item.name === conditionSingleData.property;
    })) === null || _ruleAndIndexFieldLis === void 0 ? void 0 : _ruleAndIndexFieldLis.enumTypeValues) || [];
    if (enumTypeValues.length) {
      enumArr = enumTypeValues.filter(function (item) {
  ...
  var getBlongParamName = function getBlongParamName() {
    var paramObj = fieldParamListSelect.find(function (item) {
  ...
  var text = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, conditionType === 'group' && "".concat(Number(conditionArr[0]) + 1, ".").concat(Number(conditionArr[1]) + 1, ". "), /*#__PURE__*/_react.default.createElement("span", {
    className: "condition-value"
  }, propertyName), getOperatorName(), op && !['isnull', 'notnull'].includes(op) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, ifAppendIsStr && /*#__PURE__*/_react.default.createElement("span", {
    className: "condition-op"
  }, ifAppendIsStr && _otp.default.is), rightValueType === 'input' && propertyDataType !== 'ENUM' && !operaTypeBlong && /*#__PURE__*/_react.default.createElement("span", {
    className: "condition-value"
  }, value || value === 0 ? value : ''), rightValueType === 'context' && propertyDataType !== 'ENUM' && !operaTypeBlong && getContextNotEnumName(), propertyDataType === 'ENUM' && !operaTypeBlong && !operaTypeInOrNot && getEnumNotBlongName(), operaTypeBlong && getBlongParamName(), operaTypeInOrNot && getEnumInOrNotInName()));
  var textDom = /*#__PURE__*/_react.default.createElement("span", {
    className: "one-condition-item ".concat(conditionType === 'group' ? 'one-condition-group-item' : '')
  }, text);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, conditionType === 'group' && conditionArr[1] === 0 && /*#__PURE__*/_react.default.createElement("div", null, _otp.default.tiaojian, '&nbsp;', logicOperatorMap[logicOperator] || logicOperator), /*#__PURE__*/_react.default.createElement(_tooltip.default, {
    title: text,
    placement: "topLeft",
