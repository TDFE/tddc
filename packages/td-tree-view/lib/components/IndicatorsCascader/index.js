...
var IndicatorsCascader = function IndicatorsCascader(_ref2) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var _options$reduce = options.reduce(function (total, item) {
        ...
        if (index >= 0) {
          if (Array.isArray(total['_filterOptions'][index].data)) {
            total['_filterOptions'][index].data.push(_objectSpread(_objectSpread({}, rest), {}, {
              name: name,
          ...
          total['_filterOptions'].push({
            name: sourceKey,
            dName: sourceName,
            data: !!name ? [_objectSpread(_objectSpread({}, rest), {}, {
              sourceName: sourceName,
              name: name
            })] : [{
              name: '',
  ...
  var displayRender = function displayRender(label, selectedOptions, inputValue) {
    ...
    if (Array.isArray(selectedOptions) && selectedOptions.length) {
      ...
      if (!item) {
        ...
        displayDom = /*#__PURE__*/_react.default.createElement("div", {
  ...
  var renderItem = function renderItem(data, level) {
    var _data$children;
    var isLast = !(data === null || data === void 0 ? void 0 : (_data$children = data.children) === null || _data$children === void 0 ? void 0 : _data$children.length);
    if (!data.dName) {
      return /*#__PURE__*/_react.default.createElement(EnptyContent, null);
    }
    var dom = /*#__PURE__*/_react.default.createElement("span", null, isLast && level !== 0 && /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      data: data
    }), data === null || data === void 0 ? void 0 : data.dName);
    if (level === 0) {
      return dom;
    }
    return /*#__PURE__*/_react.default.createElement(_tntd.Ellipsis, {
      widthLimit: '100%',
      title: dom
    }, dom);
  };
  ...
  var handleSearchRender = function handleSearchRender(inputValue, path) {
    var _path$;
    var dom = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      data: path === null || path === void 0 ? void 0 : path[1]
    }), path === null || path === void 0 ? void 0 : (_path$ = path[1]) === null || _path$ === void 0 ? void 0 : _path$['dName']);
    return /*#__PURE__*/_react.default.createElement("div", {
  ...
  var getTitle = function getTitle(item) {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      key: 1,
      data: item
    }), item === null || item === void 0 ? void 0 : item.dName);
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_tntd.Tooltip, {
    placement: "top",
    title: !(0, _lodash.isEmpty)(choosedItem) && setTitle ? setTitle([/*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      key: 1,
      data: choosedItem
    }), choosedItem === null || choosedItem === void 0 ? void 0 : choosedItem.dName]) : getTitle(choosedItem)
  }, disabled ? /*#__PURE__*/_react.default.createElement(_tntd.Select, {
    value: value,
    disabled: true,
    style: _objectSpread({
      minWidth: '200px'
    ...
    return /*#__PURE__*/_react.default.createElement(_tntd.Select.Option, {
      value: i.name,
      key: i.name
    }, /*#__PURE__*/_react.default.createElement(_CascaderTag.default, {
      data: choosedItem
    }), i === null || i === void 0 ? void 0 : i.dName);
  })) : /*#__PURE__*/_react.default.createElement(_virtualCascader.default, _objectSpread(_objectSpread({
    displayRender: displayRender
  }, rest), {}, {
    className: "".concat((rest === null || rest === void 0 ? void 0 : rest.className) || '', " virtual-indicators-cascader"),
...
var _default = exports.default = /*#__PURE__*/(0, _react.memo)(IndicatorsCascader, function (prevProps, nextProps) {
  return (0, _lodash.isEqual)(prevProps.options, nextProps.options) && (0, _lodash.isEqual)(prevProps.disabled, nextProps.disabled) && prevProps.value === nextProps.value;
});