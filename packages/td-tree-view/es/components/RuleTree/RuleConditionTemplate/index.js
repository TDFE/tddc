...
var RuleConditionTemplate = function RuleConditionTemplate(props) {
  ...
  var cfgJson =
    currentTemplate && currentTemplate.cfgJson && isJSON(currentTemplate.cfgJson)
      ...
      : null;
  var simpleCfgList = getRuleCfgList(cfgJson, params);
  ...
  var dom = /*#__PURE__*/ React.createElement(
    ...
    property &&
      ...
      /*#__PURE__*/ React.createElement(CustomRuleConfig, {
        data: data,
              ...
              item.children &&
                item.children.map(function (subItem) {
                  ...
                  if (changeMode === 'whenSomeValue') {
                    ...
                    // 当为具体类型的时候
                    var _type = getHandleType(changeHandleObj, allMap);
                    caseList &&
                      caseList.map(function (caseItem) {
                        if (
                          caseItem['modeValueList'] &&
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(_Ellipsis, {
            title: ''.concat(otp.guize).concat(description),
            placement: 'bottom',
            widthLimit: 450,
          }),
        ),
