...
export default (function (props) {
  ...
  var _ref = allMap || {},
    ...
    multiDimCustomListBusiTypeSelect =
      _ref$multiDimCustomLi === void 0 ? [] : _ref$multiDimCustomLi,
  ...
  var defineTypeName =
    (
      multiDimCustomListTypeSelect.find(function (v) {
        return v.name === defineType;
      }) || {}
    ).dName || defineType;
  var definitionListName =
    (
      customList.find(function (v) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      '匹配字段：',
      conditions &&
        conditions.map(function (conditionItem, index) {
          ...
          if (busiTypeObj) {
            multiDimCustomListBusiTypeObj = multiDimCustomListBusiTypeSelect.find(function (
              typeItem,
            ) {
          ...
          if (fieldList && fieldList.length) {
            var leftValueNameObj =
              fieldList.find(function (v) {
                return v.name === leftValue;
              }) || {};
            leftSourceName = '['.concat(sourceName(leftValueNameObj.sourceName, lang), ']');
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            leftDName,
            rightDName,
            (weight || weight === 0) && '\u6743\u91CD'.concat(weight, '%'),
            multiDimCustomListBusiTypeObj && multiDimCustomListBusiTypeObj.dName,
          );
        }),
    ),
    /*#__PURE__*/ React.createElement('span', null, '匹配度：', score || score === 0 ? score : ''),
  );
});
