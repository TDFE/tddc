...
export const NODE_TYPE_MAP = {
  ...
  INDEX_OFFLINE: { en: 'O', cn: '离', color: '#BC6BC6' }, // 离线指标
  INDEX_OFFLINE_VERSION: { en: 'O', cn: '离', color: '#BC6BC6' }, // 离线指标版本
  INDEX_FEATURE_SET: { en: 'O', cn: '离', color: '#BC6BC6' }, // 离线指标集
  INDEX_FEATURE_SET_VERSION: { en: 'O', cn: '离', color: '#BC6BC6' }, // 离线指标集版本
  ...
  NAME_LIST: { en: 'L', cn: '名', color: '#E6A133' },
