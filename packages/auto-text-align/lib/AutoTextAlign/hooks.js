...
var useAdjustAlign = function useAdjustAlign(widthList, containerRef, initColumnLen) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var getContainerWidth = function getContainerWidth() {
      ...
      var containerWidth = (_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 ? void 0 : (_containerRef$current2 = _containerRef$current.getBoundingClientRect()) === null || _containerRef$current2 === void 0 ? void 0 : _containerRef$current2.width;
      setContainerWidth(containerWidth);
    };
    if (dom) {
      var _dom$getBoundingClien;
      var _containerWidth = dom === null || dom === void 0 ? void 0 : (_dom$getBoundingClien = dom.getBoundingClientRect()) === null || _dom$getBoundingClien === void 0 ? void 0 : _dom$getBoundingClien.width;
