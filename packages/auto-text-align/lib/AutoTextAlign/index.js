...
var AutoTextAlign = function AutoTextAlign(_ref) {
  ...
  var widthList = (0, _react.useMemo)(function () {
    return list === null || list === void 0 ? void 0 : list.map(function (_ref2) {
      var label = _ref2.label,
          value = _ref2.value;
      return (0, _utils.getTextWidth)(label + ':', labelFontSize) + (0, _utils.getTextWidth)(value, valueFontSize) + itemSpace + 15;
    });
  }, [list]); // 获取每一列的宽度
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    var label = _ref3.label,
        value = _ref3.value;
    var width = columns[index % (columns === null || columns === void 0 ? void 0 : columns.length)];
    return /*#__PURE__*/_react.default.createElement("div", {
      key: label,
