...
var Tree = /*#__PURE__*/function (_Base) {
  ...
  _createClass(Tree, [{
    ...
    value: function init(props) {
      ...
      this.constant.COMPONENT_SPACE_VERTICAL = spaceVertical || _constants.COMPONENT_SPACE_VERTICAL; // 节点垂直之间的间隙
      this.constant.COMPONENT_SPACE_HORIZONTAL = spaceHorizontal || _constants.COMPONENT_SPACE_HORIZONTAL; // 节点水平之间的间隙
    ...
    value: function drawNode() {
      ...
      var result = [];
      // 扁平化树
      this.flattenNodes = ((_this$Nodes = this.Nodes) === null || _this$Nodes === void 0 ? void 0 : _this$Nodes.descendants()) || [];
      ((_this$flattenNodes = this.flattenNodes) === null || _this$flattenNodes === void 0 ? void 0 : _this$flattenNodes.forEach(function (node) {
        var data = node.data,
          x = node.x,
          y = node.y;
        var key = data.key,
        ...
        var Eledom = function Eledom() {
          var NodeIns = _this2.nodeDom && _this2.nodeDom({
            node: node,
        ...
        result.push( /*#__PURE__*/_react.default.createElement(Ele, {
    ...
    value: function drawLine() {
      var _this$Nodes2,
        _this3 = this;
      this.flattenLinks = ((_this$Nodes2 = this.Nodes) === null || _this$Nodes2 === void 0 ? void 0 : _this$Nodes2.links()) || [];
      var result = [];
      result = (this === null || this === void 0 ? void 0 : this.flattenLinks.map(function (link) {
        ...
        if (!source.parent) {
          ...
          if (_this3.fixed) {
            ...
            x = source.y + (nodeNameWidth > _this3.constant.COMPONENT_WIDTH ? nodeNameWidth : _this3.constant.COMPONENT_WIDTH);
          }
        }
        var length = (source === null || source === void 0 ? void 0 : (_source$data = source.data) === null || _source$data === void 0 ? void 0 : _source$data.children.length) || (source === null || source === void 0 ? void 0 : (_source$data2 = source.data) === null || _source$data2 === void 0 ? void 0 : _source$data2._children.length) || 0;
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          root: !source.parent,
          color: source === null || source === void 0 ? void 0 : (_source$data3 = source.data) === null || _source$data3 === void 0 ? void 0 : _source$data3.color,
          length: length,
          source: {
            x: x,
            y: source.x
    ...
    value: function buildPosition(data) {
      ...
      var domWidth = 0;
      var domHeight = 0;
      var Nodes = data === null || data === void 0 ? void 0 : data.eachAfter(function (node) {
        var exceedWidth = _this4.calcWidth(node) || 0;
        var children = node.children,
          data = node.data,
          parent = node.parent;
        if (!_this4.fixed) {
          node.y = node.depth * (_this4.constant.COMPONENT_WIDTH + _this4.constant.COMPONENT_SPACE_HORIZONTAL) + exceedWidth;
        } else {
          node.y = node.depth * (_this4.constant.COMPONENT_WIDTH + _this4.constant.COMPONENT_SPACE_HORIZONTAL);
        }
        ...
        if (parent === null) {
          node.y = 0;
          node.x = children && children.length ? (children[0].x + children[children.length - 1].x) / 2 : 0;
        } else if (data.type === 'relation') {
          node.x = children && children.length ? (children[0].x + children[children.length - 1].x) / 2 : 0;
        } else {
          node.x = leafCount * (_this4.constant.COMPONENT_HEIGHT + _this4.constant.COMPONENT_SPACE_VERTICAL);
          leafCount += 1;
        }
        domWidth = Math.max(node.y + (0, _utils.getTextPixelWith)(node.data.nodeName || ''), domWidth);
    ...
    key: "expand",
    value: function () {
      var _expand = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    key: "packUp",
    value: function () {
      var _packUp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    set: function set(target, propertyKey, value) {
      if (propertyKey === 'data') {
        ...
        if (target.initType === true || !target.interaction) {
          var _value$children;
          value === null || value === void 0 ? void 0 : (_value$children = value.children) === null || _value$children === void 0 ? void 0 : _value$children.forEach(_utils.expandTree);
        } else {
          var _value$children2;
          value === null || value === void 0 ? void 0 : (_value$children2 = value.children) === null || _value$children2 === void 0 ? void 0 : _value$children2.forEach(_utils.collapseTree);
        }
