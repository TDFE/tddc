      ...
      if (children.length) {
        children.forEach(function (child, index) {
          ...
          var _ref = child || {},
            key = _ref.key;
          var color = '';
          color = _constants.NODE_TYPE_MAP && ((_NODE_TYPE_MAP$child$ = _constants.NODE_TYPE_MAP[child.nodeType]) === null || _NODE_TYPE_MAP$child$ === void 0 ? void 0 : _NODE_TYPE_MAP$child$.color) || parentColor;
          ...
          if (child.children && child.children.length) {
            node.type = 'relation';
            node.children = _this2.addDropAreaAndOperation(child.children, path.concat(['children']), level + 1, color);
            path.push('relation');
          }
          result.push(node);
        });
